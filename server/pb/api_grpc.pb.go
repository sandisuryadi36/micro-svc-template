...
func (c *apiServiceClient) Hello(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/responsetimesimulation.service.ApiService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ApiService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/responsetimesimulation.service.ApiService/Hello",
	}
